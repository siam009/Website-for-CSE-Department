...
class UpdateController extends Controller
{
	...
	public function checkUpdateView()
	{
		if (Auth::guard('admin')->check()){
			return view('pages.admin.UpdateResult.check');
		}
	...
	public function checkUpdate(Request $request)
	{
		...
		if($year==1 && $semester==1){
			...
			if(count($result)>0){
				return view('pages.admin.UpdateResult.res_1_2')->with('result',$result);
			}
			else dd('not match');
		}
			...
			if(count($result)>0){
				return view('pages.admin.UpdateResult.res_2_1')->with('result',$result);
			}
			else dd('not match');
		}
			...
			if(count($result)>0){
				return view('pages.admin.UpdateResult.res_2_2')->with('result',$result);
			}
			else dd('not match');
		}
			...
			if(count($result)>0){
				return view('pages.admin.UpdateResult.res_3_1')->with('result',$result);
			}
			else dd('not match');
		}
			...
			if(count($result)>0){
				return view('pages.admin.UpdateResult.res_3_2')->with('result',$result);
			}
			else dd('not match');
		}
			...
			if(count($result)>0){
				return view('pages.admin.UpdateResult.res_4_1')->with('result',$result);
			}
			else dd('not match');
		}
			...
			if(count($result)>0){
				return view('pages.admin.UpdateResult.res_4_2')->with('result',$result);
			}
			else dd('not match');
		}
    ...
    /*public function view_update_1_1(){
        return view('pages.admin.UpdateResult.res_1_1');
    }
    public function view_update_1_2(){
        return view('pages.admin.UpdateResult.res_1_2');
    }
    public function view_update_2_1(){
        return view('pages.admin.UpdateResult.res_2_1');
    }
    public function view_update_2_2(){
        return view('pages.admin.UpdateResult.res_2_2');
    }
    public function view_update_3_1(){
        return view('pages.admin.UpdateResult.res_3_1');
    }
    public function view_update_3_2(){
        return view('pages.admin.UpdateResult.res_3_2');
    }
    public function view_update_4_1(){
        return view('pages.admin.UpdateResult.res_4_1');
    }
    public function view_update_4_2(){
        return view('pages.admin.UpdateResult.res_4_2');
    } */




    public function Update_1_1(Request $request)
    {
    	if (Auth::guard('admin')->check()){
    ...
    public function Update_1_2(Request $request)
    {
    ...
    public function Update_2_1(request $request)
    {
       ...
       public function Update_2_2(Request $request)
    {
    	if (Auth::guard('admin')->check()){
    ...
    dd($result);
       ...
       public function Update_3_1(Request $request)
    {
    	if (Auth::guard('admin')->check()){
            $result =Result_3_1::where('Registration_no',$request->Registration_no)->get();
	         if(count($result)>0){
       ...
       public function Update_3_2(Request $request)
    {
    	if (Auth::guard('admin')->check()){
        $result =Result_3_2::where('Registration_no',$request->Registration_no)->get();
	         if(count($result)>0){
       ...
       public function Update_4_1(Request $request)
    {
       ...
       public function Update_4_2(Request $request)
    {
    	if (Auth::guard('admin')->check()){
        $result =Result_4_2::where('Registration_no',$request->Registration_no)->get();
	         if(count($result)>0){
